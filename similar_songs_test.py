...
class TestSimilarSongHandling(unittest.TestCase):
    ...
    def test_call_with_same_data_returns_true(self):
        entry = self.TestEntry("hello", "artist")
        self.assertTrue(further_comparison_checks(entry, entry))
    ...
    def test_different_punctuation_ok(self):
        ...
        second = self.TestEntry("Are You Lonesome Tonight?", "Elvis Presley")
    ...
    def test_drop_featuring_words(self):
        ...
        second = self.TestEntry("Area Codes", "Ludacris Featuring Nate Dogg")
        self.assertTrue(further_comparison_checks(first, second),
...
test_set = [
    ...
    (("Are You Lonesome Tonight", "Elvis Presley With The Jordanaires"),
     ("Are You Lonesome Tonight?",
      "Elvis Presley"), 24.478643, False),  # At least for the first iteration
...
set_2 = [
    ...
    (("Are You Sure Hank Done It This Way/bob Wills Is Th", "Waylon Jennings"),
     ("Are You Sure Hank Done It This Way",
      "Waylon Jennings"), 34.55643, False),
    ...
    (("Arms Around You", "Xxxtentacion/Pump/Maluma/Swae"),
     ("Arms Around You",
      "XXXTENTACION x Lil Pump Featuring Maluma & Swae Lee"), 23.395634,
     False),
    ...
    (("As Long As You Love Me (Acoustic)", "Justin Bieber"),
     ("As Long As You Love Me",
      "Justin Bieber Featuring Big Sean"), 27.729881, False),
    ...
    (("Ayo Technology", "50 Cent/Timberlake/Timbaland"),
     ("Ayo Technology",
      "50 Cent Featuring Justin Timberlake & Timbaland"), 34.015205, False),
    (("Babushka Boi", "Asap Rocky"), ("Babushka Boi", "A$AP Rocky"), 28.824451,
     False),  # Bleh, leetspeak
    (("Baby 1 More Time", "Britney Spears"), ("...Baby One More Time",
                                              "Britney Spears"), 20.426449,
     False),  # Also numbers
    (("Baby Baby Bye Bye", "Jerry Lee Lewis"), ("Baby, Bye Bye", "Dickey Lee"),
     33.12935, False),
    (("Baby Be Mine Ft Teddy Riley", "Blackstreet Featuring Teddy Riley"),
     ("Baby Be Mine (From 'CB4')",
      "BLACKstreet (Featuring Teddy Riley)"), 21.800598, False),
    ...
    (("Baby Come To Me", "Patti Austin And James Ingram"),
     ("Baby, Come To Me",
      "Patti Austin A Duet With James Ingram"), 20.972834, False),
    ...
    (("Baby It's Cold Outside", "Brett Eldredge/Meghan Trainor"),
     ("Baby, It's Cold Outside",
      "Brett Eldredge Featuring Meghan Trainor"), 32.468742, True),
    (("Baby It's Cold Outside", "Dean Martin"),
     ("Baby, It's Cold Outside",
      "Dean Martin & Martina McBride"), 25.553116, False),
    (("Baby It's Cold Outside", "Idina Menzel Ft Michael Buble"),
     ("Baby It's Cold Outside",
      "Idina Menzel Duet With Michael Buble"), 30.669731, False),
